                                        ...
                                        <div class="pl-3">
                                            <div class="mb-2">
                                                <a href="https://laravel.com/docs"
                                                    class="h5 font-weight-bolder text-dark">Documentation</a>
                                            </div>
                                            <p class="text-muted small">
                                                Laravel has wonderful, thorough documentation covering every aspect of the
                                                framework. Whether you are new to the framework or have previous experience
                                                with Laravel, we recommend reading all of the documentation from beginning
                                                to end.
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="pl-3">
                                            <div class="mb-2">
                                                <a href="https://laracasts.com"
                                                    class="h5 font-weight-bolder text-dark">Laracasts</a>
                                            </div>
                                            <p class="text-muted small">
                                        ...
                                        <div class="pl-3 text-sm">
                                            <div class="mb-2">
                                                <a href="https://laravel-news.com/"
                                                    class="h5 font-weight-bolder text-dark">Laravel News</a>
                                            </div>
                                            <p class="text-muted small">
                                        ...
                                        <div class="pl-3">
                                            ...
                                            <p class="text-muted small">
                                                Laravel's robust library of first-party tools and libraries, such as <a
                                                    href="https://forge.laravel.com" class="text-muted">Forge</a>, <a
                                                    href="https://vapor.laravel.com" class="text-muted">Vapor</a>, <a
                                                    href="https://nova.laravel.com" class="text-muted">Nova</a>, and <a
                        ...
                        <div class="text-sm text-muted">
                            <div class="flex align-content-center">
                                ...
                                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2" viewBox="0 0 24 24" class="ms-4 text-muted" style="width: 18px">
                                    <path
