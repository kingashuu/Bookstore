    ...
    <div class="wrap-footer-content footer-style-1">
        ...
        <div class="wrap-function-info">
            <div class="container">
                ...
                {{-- <div class="d-flex "> --}}
                    <h2 class="item-header align-middle pt-4">Sign up for newsletter</h2>
                    <div class="wrap-footer-itemx footer-item-secondx w-50 align-middle ">
                        <div class="item-content">
                            <div class="wrap-newletter-footer my-5">
                                <form action="#" class="frm-newletter" id="frm-newletter">
                                    <input type="email" class="input-email" name="email" value=""
                                        placeholder="Enter your email address">
                                    <button class="btn-submit" style="background-color: #444444">Subscribe</button>
                                </form>
                            </div>
                        </div>
                    </div>
